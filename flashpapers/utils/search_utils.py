...
class SearchUtils:
    ...
    def search_by_title(self, title_query: str) -> List[Flashpaper]:
        """
    ...
    def search_by_author(self, author_query: str) -> List[Flashpaper]:
        """
    ...
    def filter_by_category(self, category: str) -> List[Flashpaper]:
        """
    ...
    def filter_by_keyword(self, keyword: str) -> List[Flashpaper]:
        """
    ...
    def get_recent_papers(self, limit: int = 10) -> List[Flashpaper]:
        """
